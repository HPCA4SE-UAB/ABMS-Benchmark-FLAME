...
#SBATCH --ntasks=4                  # Number of MPI ranks
rm profile.*
mpiexec -n 4 ./main 100 0_7.xml -r > ./output/sortida4.txt ; 
pprof -p > ./output/pprof_out4;

#SBATCH --nodes=1
#SBATCH --ntasks=8                  # Number of MPI ranks
rm profile.*
mpiexec -n 8 ./main 100 0_7.xml -r > ./output/sortida8.txt ; 
pprof -p > ./output/pprof_out8;

#SBATCH --nodes=2
#SBATCH --ntasks=16                  # Number of MPI ranks
rm profile.*
mpiexec -n 16 ./main 100 0_7.xml -r > ./output/sortida16.txt ; 
pprof -p > ./output/pprof_out16;


#SBATCH --nodes=3
#SBATCH --ntasks=32                  # Number of MPI ranks
rm profile.*
mpiexec -n 32 ./main 100 0_7.xml -r > ./output/sortida32.txt ; 
pprof -p > ./output/pprof_out32;
